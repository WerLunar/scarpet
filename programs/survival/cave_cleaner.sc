// Kill zombies/drowneds holding naturally dropped items within 128 blocks of the player
...
// Be aware of zombies/drowneds that users want to keep might be removed if they are holding items listed in the if condition
...
__command() -> (
    ...
    count = 0;
    l (x, y, z) = pos(player());
    for (zombies = entity_area('zombie', x,y,z, 128,128,128), 
        holding = query(_, 'holds', 'mainhand');
        if (holding != null, 
            holding_item = get(holding,0);
            if (holding_item == 'string' || holding_item == 'rotten_flesh' || holding_item == 'bone' || holding_item == 'arrow' || holding_item == 'spider_eye' || holding_item == 'glass_bottle' || holding_item == 'gunpowder' || holding_item == 'sugar' || holding_item == 'stick' || holding_item == 'glowstone_dust' || holding_item == 'redstone' || holding_item == 'egg' || holding_item == 'brown_mushroom' || holding_item == 'red_mushroom' || holding_item == 'slime_ball' , 
                modify(_, 'remove');
                count = count + 1
            )
        )
    );
    for (zombies = entity_area('zombie_villager', x,y,z, 128,128,128), 
        holding = query(_, 'holds', 'mainhand');
        if (holding != null, 
            holding_item = get(holding,0);
            if (holding_item == 'string' || holding_item == 'rotten_flesh' || holding_item == 'bone' || holding_item == 'arrow' || holding_item == 'spider_eye' || holding_item == 'glass_bottle' || holding_item == 'gunpowder' || holding_item == 'sugar' || holding_item == 'stick' || holding_item == 'glowstone_dust' || holding_item == 'redstone' || holding_item == 'egg' || holding_item == 'brown_mushroom' || holding_item == 'red_mushroom' || holding_item == 'slime_ball' , 
    ...
    for (drowneds = entity_area('drowned', x,y,z, 128,128,128), 
        holding = query(_, 'holds', 'mainhand');
        if (holding != null, 
            holding_item = get(holding,0);
            if (holding_item == 'string' || holding_item == 'rotten_flesh' || holding_item == 'bone' || holding_item == 'arrow' || holding_item == 'spider_eye' || holding_item == 'glass_bottle' || holding_item == 'gunpowder' || holding_item == 'sugar' || holding_item == 'stick' || holding_item == 'glowstone_dust' || holding_item == 'redstone' || holding_item == 'egg' || holding_item == 'brown_mushroom' || holding_item == 'red_mushroom' || holding_item == 'slime_ball' , 
